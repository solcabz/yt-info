...
exports.getLikes = info => {
  try {
    ...
    let like = buttons.find(b => b.segmentedLikeDislikeButtonViewModel)
    return parseInt(like.segmentedLikeDislikeButtonViewModel.likeButtonViewModel.likeButtonViewModel.toggleButtonViewModel.toggleButtonViewModel.defaultButtonViewModel.buttonViewModel.accessibilityText.replace(/\D+/g, ''));
  } catch (err) {
    return null;
  }
};
